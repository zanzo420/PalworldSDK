...
{
public:
	uint8                                        Pad_B84[0x1];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_B8B[0x6];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_BA3[0x1];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_BB6[0x1];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
