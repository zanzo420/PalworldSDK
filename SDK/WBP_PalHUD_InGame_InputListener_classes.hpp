...
public:
	...
	struct FPalUIActionBindData                  CharacterMenuActionHandle;                         // 0x478(0x4)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor)
	...
	struct FPalUIActionBindData                  WorldMapActionHandle;                              // 0x490(0x4)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor)
	struct FPalUIActionBindData                  TechnologyMenuActionHandle;                        // 0x494(0x4)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor)
	struct FPalUIActionBindData                  PalStatusActionHandle;                             // 0x498(0x4)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor)

	static class UClass* StaticClass();
	static class UWBP_PalHUD_InGame_InputListener_C* GetDefaultObj();

	void CREATEDELEGATE_PROXYFUNCTION_0(struct FPalKeyConfigSettings& PrevSettings, struct FPalKeyConfigSettings& NewSettings);
	void OnKeyConfigChanged(const struct FPalKeyConfigSettings& PreSetting, const struct FPalKeyConfigSettings& NewSetting, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, const struct FPalUIActionBindData& CallFunc_RegisterActionBinding_ReturnValue, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_1, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_2, const struct FPalUIActionBindData& CallFunc_RegisterActionBinding_ReturnValue_1, const struct FPalUIActionBindData& CallFunc_RegisterActionBinding_ReturnValue_2, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_3, const struct FPalUIActionBindData& CallFunc_RegisterActionBinding_ReturnValue_3);
