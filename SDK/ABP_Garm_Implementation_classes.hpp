...
{
public:
	uint8                                        Pad_5A8A[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_5A8B[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FAnimNode_LookAt                      AnimGraphNode_LookAt_2;                            // 0x6F0(0x250)(None)
	...
	struct FAnimNode_LookAt                      AnimGraphNode_LookAt_1;                            // 0x980(0x250)(None)
	struct FAnimNode_LookAt                      AnimGraphNode_LookAt;                              // 0xBD0(0x250)(None)
	struct FAnimNode_Root                        AnimGraphNode_Root;                                // 0xE20(0x20)(None)
	struct FVector                               LookAtWorldLocation;                               // 0xE40(0x18)(BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

	static class UClass* StaticClass();
	static class UABP_Garm_Implementation_C* GetDefaultObj();
