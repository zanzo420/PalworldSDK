...
void UWBP_PlayerRadialMenu_C::IsPlayerDying(bool* IsDying, class APalPlayerCharacter* CallFunc_GetPalmi_ReturnValue, class UPalStatusBase* CallFunc_GetExecutionStatus_ReturnValue, bool CallFunc_IsValid_ReturnValue, bool CallFunc_IsValid_ReturnValue_1)
{
	...
	Params::UWBP_PlayerRadialMenu_C_IsPlayerDying_Params Parms{};
...
// bool                               CallFunc_IsPlayerDying_IsDying                                   (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UPalHUDService*              CallFunc_GetHUDService_ReturnValue                               (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
void UWBP_PlayerRadialMenu_C::OpenConstructionMenu(class FName SelectMapObjectId, int32 SelectedIndex, bool CallFunc_GreaterEqual_IntInt_ReturnValue, int32 CallFunc_Divide_IntInt_ReturnValue, bool CallFunc_IsPlayerDying_IsDying, class UPalHUDService* CallFunc_GetHUDService_ReturnValue, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, bool CallFunc_HasConstructionMenu_HasMenu, class UWBP_IngameMenuConstruction_Radial_C* CallFunc_CreateConstructionMenu_createdWidget, bool CallFunc_IsPlayerRiding_IsRiding, bool CallFunc_BooleanOR_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue)
{
	...
	Parms.CallFunc_IsPlayerDying_IsDying = CallFunc_IsPlayerDying_IsDying;
	Parms.CallFunc_GetHUDService_ReturnValue = CallFunc_GetHUDService_ReturnValue;
...
void UWBP_PlayerRadialMenu_C::Can_Open_Player_Action_Menu(bool* Result, class APalPlayerCharacter* CallFunc_GetPalmi_ReturnValue, bool CallFunc_IsValid_ReturnValue, class UPalStatusBase* CallFunc_GetExecutionStatus_ReturnValue, bool CallFunc_IsValid_ReturnValue_1, class APalPlayerCharacter* CallFunc_GetPalmi_ReturnValue_1, bool CallFunc_IsValid_ReturnValue_2, bool CallFunc_IsExecuting_ReturnValue, class APlayerController* CallFunc_GetLocalPlayerController_ReturnValue, class APalPlayerController* K2Node_DynamicCast_AsPal_Player_Controller, bool K2Node_DynamicCast_bSuccess, bool CallFunc_IsRiding_ReturnValue)
{
	...
	Params::UWBP_PlayerRadialMenu_C_Can_Open_Player_Action_Menu_Params Parms{};
...
// (Private, BlueprintCallable, BlueprintEvent)
// Parameters:
// bool                               CallFunc_Can_Open_Player_Action_Menu_Result                      (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// FDelegateProperty_                 K2Node_CreateDelegate_OutputDelegate                             (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// class UPalOtomoHolderComponentBase*CallFunc_GetOtomoHolderComponent_ReturnValue                     (ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_IsValid_ReturnValue                                     (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UWBP_PlayerRadialMenu_C::OpenPlayerActionMenu(bool CallFunc_Can_Open_Player_Action_Menu_Result, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, class UPalOtomoHolderComponentBase* CallFunc_GetOtomoHolderComponent_ReturnValue, bool CallFunc_IsValid_ReturnValue, int32 CallFunc_GetSpawnedOtomoID_ReturnValue, class APalCharacter* CallFunc_TryGetSpawnedOtomo_ReturnValue, bool CallFunc_IsValid_ReturnValue_1)
{
	...
	Parms.CallFunc_Can_Open_Player_Action_Menu_Result = CallFunc_Can_Open_Player_Action_Menu_Result;
	Parms.K2Node_CreateDelegate_OutputDelegate = K2Node_CreateDelegate_OutputDelegate;
	Parms.CallFunc_GetOtomoHolderComponent_ReturnValue = CallFunc_GetOtomoHolderComponent_ReturnValue;
	Parms.CallFunc_IsValid_ReturnValue = CallFunc_IsValid_ReturnValue;
