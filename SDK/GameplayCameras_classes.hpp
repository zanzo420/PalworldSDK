...
public:
	...
	uint8                                        Pad_27D[0x70];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_27F[0x28];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_287[0x6];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2A2[0x10];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2B0[0x4];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2B4[0x38];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2BE[0x3C];                                     // Fixing Size Of Struct [ Dumper-7 ]
