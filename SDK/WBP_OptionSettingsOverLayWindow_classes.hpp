...
public:
	...
	void SetPadKeyA();
	void ExecuteUbergraph_WBP_OptionSettingsOverLayWindow(int32 EntryPoint, bool Temp_bool_Variable, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, class UPalHUDDispatchParameterBase* CallFunc_GetParam_ReturnValue, class UBP_HUDDispatchParameter_KeyConfig_C* K2Node_DynamicCast_AsBP_HUDDispatch_Parameter_Key_Config, bool K2Node_DynamicCast_bSuccess, class FText CallFunc_GetLocalizedTextFromHandle_Text, class FText CallFunc_GetLocalizedTextFromHandle_Text_1, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_1, class FName CallFunc_MakeLiteralName_ReturnValue, const struct FPalUIActionBindData& CallFunc_RegisterActionBinding_ReturnValue, const struct FPalUIActionBindData& CallFunc_RegisterActionBinding_ReturnValue_1, bool CallFunc_EqualEqual_ByteByte_ReturnValue, const class FString& CallFunc_Conv_NameToString_ReturnValue, const struct FPalKeyAction& K2Node_MakeStruct_PalKeyAction, const class FString& CallFunc_Concat_StrStr_ReturnValue, class FName CallFunc_Map_Find_Value, bool CallFunc_Map_Find_ReturnValue, class FName CallFunc_Conv_StringToName_ReturnValue, class FName K2Node_Select_Default, class FText CallFunc_GetLocalizedText_ReturnValue, const class FString& CallFunc_Conv_NameToString_ReturnValue_1, const struct FFormatArgumentData& K2Node_MakeStruct_FormatArgumentData, const class FString& CallFunc_Concat_StrStr_ReturnValue_1, TArray<struct FFormatArgumentData>& K2Node_MakeArray_Array, class FName CallFunc_Conv_StringToName_ReturnValue_1, class FText CallFunc_Format_ReturnValue, class FText CallFunc_GetLocalizedText_ReturnValue_1, const struct FFormatArgumentData& K2Node_MakeStruct_FormatArgumentData_1, TArray<struct FFormatArgumentData>& K2Node_MakeArray_Array_1, class FText CallFunc_Format_ReturnValue_1);
};
