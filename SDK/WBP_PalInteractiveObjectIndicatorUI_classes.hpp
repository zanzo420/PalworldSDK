...
public:
	...
	void Update_Button_Type(enum class EPalInteractiveObjectButtonType NewButtonType, double NewLongPushTime, bool IsValidInteract, bool CanToggle, bool K2Node_SwitchEnum_CmpSuccess);
	...
	void StartTriggerInteract(bool CallFunc_IsToggleInteract_ReturnValue, bool CallFunc_BooleanAND_ReturnValue, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue, class APawn* CallFunc_K2_GetPawn_ReturnValue, class UPalInteractComponent* CallFunc_GetComponentByClass_ReturnValue);
