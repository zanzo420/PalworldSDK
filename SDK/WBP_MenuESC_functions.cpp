...
// class FString                      CallFunc_GetInviteCode_ReturnValue                               (ZeroConstructor, HasGetValueTypeHash)
// class UWBP_MenuESCPlayerListItem_C*CallFunc_Create_ReturnValue                                      (ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_IsEmpty_ReturnValue                                     (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// TArray<struct FPlayerListItem>     CallFunc_GetPlayerList_ReturnValue                               (ReferenceParm)
// struct FPlayerListItem             CallFunc_Array_Get_Item_1                                        (None)
