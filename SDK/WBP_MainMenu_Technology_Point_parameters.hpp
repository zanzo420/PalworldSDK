...
struct UWBP_MainMenu_Technology_Point_C_OnUpdateTechnologyPoint_Params
{
public:
...
struct UWBP_MainMenu_Technology_Point_C_ExecuteUbergraph_WBP_MainMenu_Technology_Point_Params
{
public:
	...
	int32                                        CallFunc_GetBossTechnologyPoints_ReturnValue;      // 0x3C(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                        CallFunc_GetTechnologyPoints_ReturnValue;          // 0x40(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_564D[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class UPalTechnologyData*                    CallFunc_GetLocalTechnologyData_ReturnValue_1;     // 0x48(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class UUMGSequencePlayer*                    CallFunc_PlayAnimation_ReturnValue_3;              // 0x70(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FDataTableRowHandle                   K2Node_Select_Default_1;                           // 0x78(0x10)(NoDestructor)
