...
{
public:
	uint8                                        Pad_835[0x18];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_83A[0xD8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_86E[0x148];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_86F[0x1F8];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_87F[0x6];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_880[0x28];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_890[0x20];                                     // Fixing Size Of Struct [ Dumper-7 ]
