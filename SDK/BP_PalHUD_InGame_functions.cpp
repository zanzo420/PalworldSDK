...
void ABP_PalHUD_InGame_C::ReceiveDrawHUD(int32 SizeX, int32 SizeY)
{
	...
	Params::ABP_PalHUD_InGame_C_ReceiveDrawHUD_Params Parms{};
...
void ABP_PalHUD_InGame_C::ExecuteUbergraph_BP_PalHUD_InGame(int32 EntryPoint, class UPalDebugSetting* CallFunc_GetPalDebugSetting_ReturnValue, bool CallFunc_IsValid_ReturnValue, class UClass* Temp_class_Variable, class UClass* K2Node_ClassDynamicCast_AsPal_User_Widget_Stackable_UI, bool K2Node_ClassDynamicCast_bSuccess, TSubclassOf<class UObject> K2Node_CustomEvent_Loaded_1, const struct FGuid& CallFunc_PushWidgetStackableUI_ReturnValue, class UClass* Temp_class_Variable_1, class UClass* K2Node_ClassDynamicCast_AsPal_User_Widget, bool K2Node_ClassDynamicCast_bSuccess_1, TSubclassOf<class UObject> K2Node_CustomEvent_Loaded, class UClass* Temp_class_Variable_2, class UClass* K2Node_ClassDynamicCast_AsPal_User_Widget_1, bool K2Node_ClassDynamicCast_bSuccess_2, class UPalUserWidget* CallFunc_CreateHUDWidget_ReturnValue, bool Temp_bool_Variable, enum class EPalHUDWidgetPriority Temp_byte_Variable, TSubclassOf<class UObject> K2Node_CustomEvent_Loaded_2, class APlayerController* CallFunc_GetPlayerController_ReturnValue, float K2Node_Event_DeltaSeconds, enum class EEndPlayReason K2Node_Event_EndPlayReason, bool CallFunc_IsValid_ReturnValue_1, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, TSoftClassPtr<class UPalUserWidget> K2Node_CustomEvent_widgetClass, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_1, class APalPlayerCharacter* K2Node_CustomEvent_PlayerCharacter, class UPalHUDService* CallFunc_GetHUDService_ReturnValue, const struct FGuid& CallFunc_Push_ReturnValue, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_2, enum class EPalHUDWidgetPriority CallFunc_Map_Find_Value, bool CallFunc_Map_Find_ReturnValue, class APalPlayerCharacter* K2Node_CustomEvent_Player, enum class EPalHUDWidgetPriority K2Node_Select_Default, class UPalUserWidget* CallFunc_CreateHUDWidget_ReturnValue_1, class UPalGameSetting* CallFunc_GetGameSetting_ReturnValue, class UPalHUDService* CallFunc_GetHUDService_ReturnValue_1, class APalPlayerCharacter* CallFunc_GetPalmi_ReturnValue, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_3, bool CallFunc_IsValid_ReturnValue_2, class UPalDamageReactionComponent* CallFunc_GetComponentByClass_ReturnValue, bool CallFunc_IsValid_ReturnValue_3, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_4, int32 K2Node_Event_SizeX, int32 K2Node_Event_SizeY)
{
	static class UFunction* Func = nullptr;
