...
class ABP_BuildObject_Bench_Wood_C : public APalBuildObject
{
public:
	class UStaticMeshComponent*                  SM_Bench;                                          // 0x580(0x8)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
	...
	static class ABP_BuildObject_Bench_Wood_C* GetDefaultObj();
