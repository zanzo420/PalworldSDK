...
public:
	...
	void Set_Action_Berserker(class AActor* Target, class AController* CallFunc_GetController_ReturnValue, class ABP_MonsterAIController_Otomo_C* K2Node_DynamicCast_AsBP_Monster_AIController_Otomo, bool K2Node_DynamicCast_bSuccess);
	...
	void ExecuteUbergraph_BP_AIAction_OtomoDefault(int32 EntryPoint, class AActor* K2Node_Event_Target);
};
