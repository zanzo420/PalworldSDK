...
public:
	...
	double                                       RandomPositionRadius;                              // 0x160(0x8)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                               To_Location;                                       // 0x168(0x18)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

	static class UClass* StaticClass();
	static class UBP_AIAction_BaseCampWorker_Wait_C* GetDefaultObj();

	void OnTickForWait(float DeltaTime, bool CallFunc_GetBaseCampRandomLocation_bResult, const struct FVector& CallFunc_GetBaseCampRandomLocation_ToLocation, enum class EPathFollowingRequestResult CallFunc_MoveToLocationInBaseCamp_ReturnValue, bool K2Node_SwitchEnum_CmpSuccess);
