...
public:
	...
	uint8                                        Pad_1DAE[0xA8];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1DB0[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1DC2[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1DC5[0xF];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1DC7[0x20];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1DCA[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1DEE[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
