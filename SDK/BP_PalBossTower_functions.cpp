...
void ABP_PalBossTower_C::UpdateBossBattleState(enum class EPalBossBattleState NewBossBattleState, bool IsOpenOld, class UPalHUDService* CallFunc_GetHUDService_ReturnValue, bool CallFunc_EqualEqual_ByteByte_ReturnValue, bool CallFunc_IsValid_Guid_ReturnValue, bool CallFunc_NotEqual_BoolBool_ReturnValue, bool K2Node_SwitchEnum_CmpSuccess)
{
	static class UFunction* Func = nullptr;
...
void ABP_PalBossTower_C::Force_Warp_Player(const TArray<class APalPlayerCharacter*>& WarpTargetPlayers, int32 Temp_int_Array_Index_Variable, class APalPlayerCharacter* CallFunc_Array_Get_Item, int32 CallFunc_Array_Length_ReturnValue, class UPalBossBattleManager* CallFunc_GetBossBattleManager_ReturnValue, int32 Temp_int_Loop_Counter_Variable, const struct FTransform& CallFunc_GetFrontWarpPoint_ReturnValue, const struct FVector& CallFunc_BreakTransform_Location, const struct FRotator& CallFunc_BreakTransform_Rotation, const struct FVector& CallFunc_BreakTransform_Scale, bool CallFunc_Less_IntInt_ReturnValue, const struct FTransform& CallFunc_GetPlayerSpawnTransformForMultiPlayer_ReturnValue, const struct FHitResult& CallFunc_K2_SetActorTransform_SweepHitResult, bool CallFunc_K2_SetActorTransform_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue, TArray<class APalPlayerCharacter*>& CallFunc_GetForceWarpTargets_ReturnValue, bool CallFunc_IsServer_ReturnValue)
{
	...
	Params::ABP_PalBossTower_C_Force_Warp_Player_Params Parms{};
