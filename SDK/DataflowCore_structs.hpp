...
{
public:
	uint8                                        Pad_3C08[0xC8];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_3C0A[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_3C0B[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_3C0C[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
