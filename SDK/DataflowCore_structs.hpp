...
{
public:
	uint8                                        Pad_2A12[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_2A13[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_2A14[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
