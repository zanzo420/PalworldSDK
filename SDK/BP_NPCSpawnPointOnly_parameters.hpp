...
public:
	...
	uint8                                        Pad_4CE8[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_4CF2[0xC];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FF_NPCOnePointSpawnInfo               K2Node_MakeStruct_F_NPCOnePointSpawnInfo;          // 0x240(0x98)(HasGetValueTypeHash)
	uint8                                        Pad_4CF4[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
