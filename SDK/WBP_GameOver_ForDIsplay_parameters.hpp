...
public:
	...
	struct FPalOptionWorldSettings               CallFunc_GetOptionWorldSettings_ReturnValue;       // 0xF8(0x138)(ConstParm)
	double                                       CallFunc_FCeil_A_ImplicitCast;                     // 0x230(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
