...
// bool                               CallFunc_IsWildNPC_ReturnValue_2                                 (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void ABP_WorldSecurity_AreaInvasion_Volume_C::ExecuteUbergraph_BP_WorldSecurity_AreaInvasion_Volume(int32 EntryPoint, const struct FGuid& CallFunc_GetInstanceId_ReturnValue, float K2Node_Event_DeltaSeconds, int32 Temp_int_Array_Index_Variable, bool CallFunc_IsPlayerOverlap_IsOverlap, TArray<class AActor*>& CallFunc_IsPlayerOverlap_OverlapPlayers, class AActor* CallFunc_Array_Get_Item, int32 CallFunc_Array_Length_ReturnValue, bool CallFunc_IsWildNPC_ReturnValue, bool CallFunc_Array_Contains_ReturnValue, int32 CallFunc_Array_AddUnique_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue, int32 Temp_int_Loop_Counter_Variable, class AActor* K2Node_Event_OtherActor, bool CallFunc_Array_RemoveItem_ReturnValue, bool CallFunc_Array_Contains_ReturnValue_1, bool CallFunc_IsWildNPC_ReturnValue_1, bool CallFunc_Less_IntInt_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue, class AActor* K2Node_Event_OtherActor_1, int32 CallFunc_Array_AddUnique_ReturnValue_1, bool CallFunc_IsWildNPC_ReturnValue_2, const struct FGuid& CallFunc_GetInstanceId_ReturnValue_1)
{
	static class UFunction* Func = nullptr;
	...
	Parms.CallFunc_IsWildNPC_ReturnValue_2 = CallFunc_IsWildNPC_ReturnValue_2;
