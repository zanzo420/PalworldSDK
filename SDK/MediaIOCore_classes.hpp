...
public:
	...
	uint8                                        Pad_127[0x18];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_128[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_129[0xD8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_12B[0x68];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_138[0xB];                                      // Fixing Size Of Struct [ Dumper-7 ]
