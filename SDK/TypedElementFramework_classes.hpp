...
{
public:
	uint8                                        Pad_38BA[0x920];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_38BE[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_38C0[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
