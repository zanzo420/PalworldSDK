...
public:
	...
	void SetEnableGuildNameEditButton(bool IsEnableFlag, bool Temp_bool_Variable, enum class ESlateVisibility Temp_byte_Variable, enum class ESlateVisibility Temp_byte_Variable_1, enum class ESlateVisibility K2Node_Select_Default, bool CallFunc_IsUGCFilter_ReturnValue);
