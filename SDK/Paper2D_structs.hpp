...
public:
	...
	uint8                                        Pad_2D5D[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_2D5E[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
