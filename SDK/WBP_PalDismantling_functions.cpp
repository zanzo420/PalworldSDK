...
// enum class EPalMapObjectOperationResultCallFunc_CanRequestDismantle_ReturnValue                         (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class FText                        CallFunc_GetLocalizedTextFromHandle_Text                         (None)
// bool                               CallFunc_EqualEqual_ByteByte_ReturnValue                         (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class FText                        CallFunc_GetMapObjectOperationResultText_outName                 (None)

void UWBP_PalDismantling_C::GetWarningText(class FText* WarningText, const struct FDataTableRowHandle& MsgId, enum class EPalMapObjectOperationResult CallFunc_CanRequestDismantle_ReturnValue, class FText CallFunc_GetLocalizedTextFromHandle_Text, bool CallFunc_EqualEqual_ByteByte_ReturnValue, class FText CallFunc_GetMapObjectOperationResultText_outName)
{
	static class UFunction* Func = nullptr;
	...
	Parms.MsgId = MsgId;
	Parms.CallFunc_CanRequestDismantle_ReturnValue = CallFunc_CanRequestDismantle_ReturnValue;
