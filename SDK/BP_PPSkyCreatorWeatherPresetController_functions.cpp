...
// Parameters:
// double                             Brightness                                                       (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// struct FVector4                    CallFunc_MakeVector4_ReturnValue                                 (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// struct FPalOptionGraphicsSettings  CallFunc_GetOptionGraphicsSettings_ReturnValue                   (ConstParm, NoDestructor)
...
void ABP_PPSkyCreatorWeatherPresetController_C::SetBrightness(double Brightness, const struct FVector4& CallFunc_MakeVector4_ReturnValue, const struct FPalOptionGraphicsSettings& CallFunc_GetOptionGraphicsSettings_ReturnValue, bool CallFunc_IsValid_ReturnValue, double CallFunc_Multiply_DoubleDouble_ReturnValue, double CallFunc_Add_DoubleDouble_ReturnValue, double CallFunc_Multiply_DoubleDouble_ReturnValue_1, double CallFunc_Add_DoubleDouble_ReturnValue_1, bool CallFunc_Greater_DoubleDouble_ReturnValue, double CallFunc_Greater_DoubleDouble_A_ImplicitCast, double CallFunc_Multiply_DoubleDouble_A_ImplicitCast, double CallFunc_Multiply_DoubleDouble_A_ImplicitCast_1)
{
	...
	Params::ABP_PPSkyCreatorWeatherPresetController_C_SetBrightness_Params Parms{};

	Parms.Brightness = Brightness;
	Parms.CallFunc_MakeVector4_ReturnValue = CallFunc_MakeVector4_ReturnValue;
	Parms.CallFunc_GetOptionGraphicsSettings_ReturnValue = CallFunc_GetOptionGraphicsSettings_ReturnValue;
...
void ABP_PPSkyCreatorWeatherPresetController_C::ExecuteUbergraph_BP_PPSkyCreatorWeatherPresetController(int32 EntryPoint, bool CallFunc_HasAuthority_ReturnValue, bool CallFunc_IsValid_ReturnValue, float CallFunc_GetTime_ReturnValue, class UPPSkyCreatorWeatherPreset* CallFunc_GetPresets_CurrentPreset, class UPPSkyCreatorWeatherPreset* CallFunc_GetPresets_NextPreset, double CallFunc_GetPresets_Alpha, int32 CallFunc_GetPresets_PresetIndex, float K2Node_Event_DeltaSeconds, const struct FPPSkyCreatorWeatherSettings& CallFunc_GetWeatherPresetSettings_ReturnValue, const struct FPPSkyCreatorWeatherSettings& CallFunc_GetWeatherPresetSettings_ReturnValue_1, double CallFunc_GetPresets_Time_ImplicitCast, float CallFunc_LerpWeatherSettings_Alpha_ImplicitCast)
{
	static class UFunction* Func = nullptr;
