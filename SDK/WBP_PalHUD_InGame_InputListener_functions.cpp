...
void UWBP_PalHUD_InGame_InputListener_C::CREATEDELEGATE_PROXYFUNCTION_0(struct FPalKeyConfigSettings& PrevSettings, struct FPalKeyConfigSettings& NewSettings)
{
	...
	Params::UWBP_PalHUD_InGame_InputListener_C_CREATEDELEGATE_PROXYFUNCTION_0_Params Parms{};
...
void UWBP_PalHUD_InGame_InputListener_C::OnKeyConfigChanged(const struct FPalKeyConfigSettings& PreSetting, const struct FPalKeyConfigSettings& NewSetting, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, const struct FPalUIActionBindData& CallFunc_RegisterActionBinding_ReturnValue, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_1, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_2, const struct FPalUIActionBindData& CallFunc_RegisterActionBinding_ReturnValue_1, const struct FPalUIActionBindData& CallFunc_RegisterActionBinding_ReturnValue_2, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_3, const struct FPalUIActionBindData& CallFunc_RegisterActionBinding_ReturnValue_3)
{
	...
	Params::UWBP_PalHUD_InGame_InputListener_C_OnKeyConfigChanged_Params Parms{};
...
void UWBP_PalHUD_InGame_InputListener_C::Setup_Input_Action(FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, class UPalOptionSubsystem* CallFunc_GetOptionSubsystem_ReturnValue, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_1, const struct FPalUIActionBindData& CallFunc_RegisterActionBinding_ReturnValue, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_2, const struct FPalUIActionBindData& CallFunc_RegisterActionBinding_ReturnValue_1, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_3, const struct FPalUIActionBindData& CallFunc_RegisterActionBinding_ReturnValue_2, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_4, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_5, const struct FPalUIActionBindData& CallFunc_RegisterActionBinding_ReturnValue_3, const struct FPalUIActionBindData& CallFunc_RegisterActionBinding_ReturnValue_4, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_6, const struct FPalUIActionBindData& CallFunc_RegisterActionBinding_ReturnValue_5)
{
	...
	Params::UWBP_PalHUD_InGame_InputListener_C_Setup_Input_Action_Params Parms{};
