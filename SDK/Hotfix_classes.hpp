...
{
public:
	uint8                                        Pad_269C[0x1D0];                                   // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_269F[0x60];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_26A3[0x23];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_26A4[0x26];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_26A5[0x58];                                    // Fixing Size Of Struct [ Dumper-7 ]
