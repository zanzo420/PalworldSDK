...
struct ABP_PPSkyCreatorWeatherPresetController_C_SetBrightness_Params
{
public:
	double                                       Brightness;                                        // 0x0(0x8)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FPalOptionGraphicsSettings            CallFunc_GetOptionGraphicsSettings_ReturnValue;    // 0x30(0x54)(ConstParm, NoDestructor)
...
public:
	...
	uint8                                        Pad_59FD[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	float                                        CallFunc_GetTime_ReturnValue;                      // 0x8(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
