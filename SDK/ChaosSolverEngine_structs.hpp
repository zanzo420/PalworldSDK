...
{
public:
	uint8                                        Pad_3719[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_371B[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_371C[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
